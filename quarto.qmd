...
How to create a project in Quarto and have it executed and deployed in GH using Github Actions without any local processing.
...
```
6) git add . && git commit -m "initial" & git push -u origin main

7) git add . && git commit -m "initial" & git push --set-upstream origin main
...
11) git add . && git commit -m "added publish-quarto.yml" & git push -u origin main
